...
Q_CONSTINIT static const uint qt_meta_data_ZN13UserDashboardE[] = {
 ...
 // properties: name, type, flags, notifyId, revision
      ...
      29, 0x80000000 | 30, 0x00015009, uint(9), 0,
      31, 0x80000000 | 30, 0x00015009, uint(10), 0,
      32, 0x80000000 | 30, 0x00015009, uint(11), 0,
      33, QMetaType::Int, 0x00015001, uint(12), 0,
...
void UserDashboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (UserDashboard::*)(const QString & );
            if (_q_method_type _q_method = &UserDashboard::errorOccurred; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (UserDashboard::*)();
            if (_q_method_type _q_method = &UserDashboard::totalInventoryItemsChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (UserDashboard::*)();
            if (_q_method_type _q_method = &UserDashboard::lowStockItemsChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (UserDashboard::*)();
            if (_q_method_type _q_method = &UserDashboard::totalInventoryValueChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _q_method_type = void (UserDashboard::*)();
            if (_q_method_type _q_method = &UserDashboard::totalSalesChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _q_method_type = void (UserDashboard::*)();
            if (_q_method_type _q_method = &UserDashboard::totalRevenueChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            using _q_method_type = void (UserDashboard::*)();
            if (_q_method_type _q_method = &UserDashboard::totalCostChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
        {
            using _q_method_type = void (UserDashboard::*)();
            if (_q_method_type _q_method = &UserDashboard::grossProfitChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 7;
                return;
            }
        }
        {
            using _q_method_type = void (UserDashboard::*)();
            if (_q_method_type _q_method = &UserDashboard::profitMarginChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 8;
                return;
            }
        }
        {
            using _q_method_type = void (UserDashboard::*)();
            if (_q_method_type _q_method = &UserDashboard::recentActivitiesChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 9;
                return;
            }
        }
        {
            using _q_method_type = void (UserDashboard::*)();
            if (_q_method_type _q_method = &UserDashboard::lowStockItemsListChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 10;
                return;
            }
        }
        {
            using _q_method_type = void (UserDashboard::*)();
            if (_q_method_type _q_method = &UserDashboard::monthlyProfitDataChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 11;
                return;
            }
        }
        {
            using _q_method_type = void (UserDashboard::*)();
            if (_q_method_type _q_method = &UserDashboard::expiringItemsChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 12;
                return;
            }
        }
        {
            using _q_method_type = void (UserDashboard::*)(int , const QString & , const QDate & );
            if (_q_method_type _q_method = &UserDashboard::itemNearExpiry; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 13;
                return;
            }
        }
