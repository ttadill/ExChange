...
static constexpr auto qt_meta_stringdata_ZN14InventoryModelE = QtMocHelpers::stringData(
    "InventoryModel",
    "errorOccurred",
    "",
    "error",
...
Q_CONSTINIT static const uint qt_meta_data_ZN14InventoryModelE[] = {
...
Q_CONSTINIT const QMetaObject InventoryModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14InventoryModelE.offsetsAndSizes,
    qt_meta_data_ZN14InventoryModelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14InventoryModelE_t,
...
void InventoryModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (InventoryModel::*)(const QString & );
            if (_q_method_type _q_method = &InventoryModel::errorOccurred; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (InventoryModel::*)();
            if (_q_method_type _q_method = &InventoryModel::lowStockItemsChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (InventoryModel::*)();
            if (_q_method_type _q_method = &InventoryModel::totalCostChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (InventoryModel::*)(int , const QString & , const QDate & );
            if (_q_method_type _q_method = &InventoryModel::itemNearExpiry; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
void *InventoryModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14InventoryModelE.stringdata0))
